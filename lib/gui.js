...
function (chroma, Map, Sidebar, Tabs, Container, Meshstats, Legend, Linklist,
  ...
  return function (config, router) {
    ...
    var newnodeslist = new SimpleNodelist("new", "firstseen", router, "Naji mazgai")
    var lostnodeslist = new SimpleNodelist("lost", "lastseen", router, "Dingę mazgai")
    ...
    sidebar.add(tabs)
    tabs.add("Naujienos", overview)
    tabs.add("Mazgai", nodelist)
    tabs.add("Jungtys", linklist)
    tabs.add("Statistika", statistics)
    tabs.add("Apie", about)
