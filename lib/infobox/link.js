define(function () {
  ...
  return function (config, el, router, d) {
    ...
    attributeEntry(attributes, "Atstumas", showDistance(d))
    attributeEntry(attributes, "Tipas", d.type)
    var hw1 = unknown ? null : dictGet(d.source.node.nodeinfo, ["hardware", "model"])
    var hw2 = dictGet(d.target.node.nodeinfo, ["hardware", "model"])
    attributeEntry(attributes, "Įranga", (hw1 != null ? hw1 : "nežinomas") + " – " + (hw2 != null ? hw2 : "nežinomas"))
