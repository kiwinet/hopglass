define(function () {
  return function (config, el, router, d) {
    ...
    sidebarTitle.textContent = "Adresas: " + d.toString()
    ...
    el.appendChild(createBox("lat", "Platuma", editLat))

    var editLng = document.createElement("input")
    editLng.type = "text"
    editLng.value = d.lng.toFixed(9)
    el.appendChild(createBox("lng", "Ilguma", editLng))
    ...
    el.appendChild(createBox("uci", "Komanda", editUci, false))
    ...
    hintText.appendChild(document.createTextNode("Jūs galite rinktis tarp "))
    hintText.appendChild(linkPlain)
    hintText.appendChild(document.createTextNode(" ir "))
    hintText.appendChild(linkUci)
    hintText.appendChild(document.createTextNode(" variantų."))
